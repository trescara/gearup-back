  ...
  return knex('gear').del()
    .then(function () {
      ...
      return knex('gear').insert([
        ...
        { id: 2, gear_type: 'harness', category: 'climb', owner: '', available: true, cost_per_day: 5, manufacturer: 'Black Diamond', renter: '', image_url: 'https://cdn.pixabay.com/photo/2015/09/09/09/02/forest-climbing-park-931256_960_720.jpg' },
        ...
        { id: 5, gear_type: 'snowboard', category: 'snow', owner: '', available: true, cost_per_day: 5, manufacturer: 'Burton', renter: '', image_url: 'https://pixnio.com/free-images/2017/10/05/2017-10-05-10-16-54-1100x733.jpg' },
